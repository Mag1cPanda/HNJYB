...
- (void)viewDidLoad {
    ...
    iconArr = @[@"danche001",@"danche002",@"danche003",@"jsz",@"IP018",
    ...
    for (NSInteger i=0; i<5; i++) {
        ...
        if (_qualifiedArr) {
            for (NSDictionary *dic in _qualifiedArr) {
                ...
                if ([dic[@"imagetype"] isEqualToString:@"6"] && i == 3) {
                    [photoDic setObject:image forKey:@"3"];
                }
                if ([dic[@"imagetype"] isEqualToString:@"7"] && i == 4) {
...
//                        NSData *imgData = [NSData dataWithContentsOfURL:[NSURL URLWithString:dic[@"imageurl"]]];
//                        cell.icon.image = [UIImage imageWithData:imgData];
...
//                    if ([dic[@"imagetype"] isEqualToString:@"20"] && (indexPath.row == 6 || indexPath.row == 7 || indexPath.row == 8)) {
//                        [cell.icon sd_setImageWithURL:[NSURL URLWithString:dic[@"imageurl"]] placeholderImage:[UIImage imageNamed:iconArr[indexPath.row]]];
//                    }
                }
            }
